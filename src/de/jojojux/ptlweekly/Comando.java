...
public class Comando implements CommandExecutor {
	...
	public void help(CommandSender sender) {
		sender.sendMessage(MensajesManager
				.getMensajeColor("&c&m                                                                    "));
		...
		sender.sendMessage(MensajesManager.getMensajeColor(
				"&8- &c/ptl message &7Enables or disables the time limit information message for yourself."));
		sender.sendMessage(
		...
		sender.sendMessage(
				MensajesManager.getMensajeColor("&8- &c/ptl resettime <player> &7Resets playtime for a player."));
		sender.sendMessage(
				MensajesManager.getMensajeColor("&8- &c/ptl addtime <player> <time> &7Adds playtime to a player."));
		sender.sendMessage(
				MensajesManager.getMensajeColor("&8- &c/ptl taketime <player> <time> &7Takes playtime from a player."));
