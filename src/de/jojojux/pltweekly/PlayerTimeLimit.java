...
import de.jojojux.ptlweekly.api.ExpansionPlayerTimeLimit;
import de.jojojux.ptlweekly.api.PlayerTimeLimitAPI;
import de.jojojux.ptlweekly.configs.ConfigsManager;
import de.jojojux.ptlweekly.listeners.PlayerListener;
...
import de.jojojux.ptlweekly.tasks.DataSaveTask;
import de.jojojux.ptlweekly.tasks.PlayerTimeTask;
import de.jojojux.ptlweekly.tasks.ServerTimeResetTask;
...
public class PlayerTimeLimit extends JavaPlugin {
	...
	public void onEnable(){
	   ...
	   Bukkit.getConsoleSender().sendMessage(nombrePlugin+ChatColor.YELLOW + "Thanks for using my plugin!  " + ChatColor.WHITE + "~JoJoJux (modified; originally Ajneb97)");
